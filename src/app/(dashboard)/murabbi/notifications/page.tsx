...
export default function MurabbiNotificationsPage() {
    ...
    return (
        <div className="space-y-6 max-w-3xl">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">Inbox & Alerts</h1>
                    <p className="text-sm text-muted-foreground mt-0.5">Track your assigned Saliks and system updates</p>
                </div>
